...
public class TaskManagementController {
    ...
    public Response<List<TaskCommentDto>> getActivity(@PathVariable Long taskId) {
        return new Response<>(taskManagementService.getActivityHistory(taskId));
    }
    ...
    @PostMapping("/fetch-by-date/smart")
    public Response<List<TaskManagementDto>> fetchSmartTasks(@RequestBody TaskFetchByDateRequest request) {
